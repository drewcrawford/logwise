...
//!
//! ```rust
//! use logwise_runtime_proc::*;
//!
//! // This macro call:
//! // logwise_runtime::info_sync!("User {name} has {count} items", name="alice", count=42);
//!
//! // Expands to approximately:
//! // {
//! //     let mut record = logwise_runtime::hidden::info_sync_pre(file!(), line!(), column!());
//! //     let mut formatter = logwise_runtime::hidden::PrivateFormatter::new(&mut record);
...
//! //     logwise_runtime::hidden::info_sync_post(record);
//! // }
//! ```
//!
//! ## Key-Value Parsing
...
/// fn main() {
///     logwise_runtime::trace_sync!("Processing {value}", value=42);
/// }
/// ```
#[proc_macro]
...
/// logwise_runtime::declare_logging_domain!();
/// async fn example() {
///     logwise_runtime::trace_async!("Processing {size} bytes", size=42);
/// }
/// fn main() {}
/// ```
#[proc_macro]
...
/// logwise_runtime::declare_logging_domain!();
/// fn main() {
///     logwise_runtime::debuginternal_sync!("Debug: {val}", val=42);
/// }
/// ```
#[proc_macro]
...
/// logwise_runtime::declare_logging_domain!();
/// async fn example() {
///     logwise_runtime::debuginternal_async!("Starting {id}", id="task_123");
/// }
/// fn main() {}
/// ```
#[proc_macro]
...
/// logwise_runtime::declare_logging_domain!();
/// fn main() {
///     logwise_runtime::info_sync!("Processing {count} items", count=42);
/// }
/// ```
#[proc_macro]
...
/// logwise_runtime::declare_logging_domain!();
/// async fn example() {
///     logwise_runtime::info_async!("Connected to {host}", host="localhost");
/// }
/// fn main() {}
/// ```
#[proc_macro]
...
/// logwise_runtime::declare_logging_domain!();
/// fn main() {
///     logwise_runtime::warn_sync!("Large payload: {size} bytes", size=1024);
/// }
/// ```
#[proc_macro]
...
/// logwise_runtime::declare_logging_domain!();
/// fn main() {
///     let interval = logwise_runtime::perfwarn_begin!("Database query");
///     // ... operation ...
///     drop(interval);
/// }
/// ```
...
/// # fn expensive() -> i32 { 42 }
/// fn main() {
///     let result = logwise_runtime::perfwarn!("Loading users", {
///         expensive()
///     });
/// }
/// ```
...
///     let interval = logwise_runtime::perfwarn_begin_if!(threshold, "operation {p}", p=42);
///     drop(interval);
/// }
/// ```
#[proc_macro]
...
/// logwise_runtime::declare_logging_domain!();
/// fn main() {
///     logwise_runtime::error_sync!("Failed to read file: {error}", error="not found");
/// }
/// ```
#[proc_macro]
...
/// logwise_runtime::declare_logging_domain!();
/// async fn example() {
///     logwise_runtime::error_async!("API failed: {error}", error="timeout");
/// }
/// fn main() {}
/// ```
#[proc_macro]
...
/// logwise_runtime::declare_logging_domain!();
/// fn main() {
///     logwise_runtime::mandatory_sync!("Debug value: {val}", val=42);
/// }
/// ```
#[proc_macro]
...
/// logwise_runtime::declare_logging_domain!();
/// async fn example() {
///     logwise_runtime::mandatory_async!("Debug: {val}", val=42);
/// }
/// fn main() {}
/// ```
#[proc_macro]
...
/// logwise_runtime::declare_logging_domain!();
/// fn main() {
///     logwise_runtime::profile_sync!("Operation took {ms} ms", ms=100);
/// }
/// ```
#[proc_macro]
...
/// logwise_runtime::declare_logging_domain!();
/// async fn example() {
///     logwise_runtime::profile_async!("Async timing: {ms} ms", ms=50);
/// }
/// fn main() {}
/// ```
#[proc_macro]
...
/// logwise_runtime::declare_logging_domain!();
/// fn main() {
///     let interval = logwise_runtime::profile_begin!("database_query");
///     // ... operation ...
///     drop(interval);
/// }
/// ```
