...
pub enum Level {
    ...
    /// Context::begin_trace();
    /// logwise_runtime::trace_sync!("Entering function with arg={val}", val=42);
    /// # }
    /// ```
    Trace,
    ...
    /// logwise_runtime::declare_logging_domain!();
    /// # fn main() {
    /// logwise_runtime::debuginternal_sync!("Internal state: count={val}", val=42);
    /// # }
    /// ```
    DebugInternal,
    ...
    /// logwise_runtime::declare_logging_domain!();
    /// # fn main() {
    /// logwise_runtime::info_sync!("Starting operation", name="data_sync");
    /// # }
    /// ```
    Info,
    ...
    /// logwise_runtime::declare_logging_domain!();
    /// # fn main() {
    /// logwise_runtime::warn_sync!("Config file not found, using defaults");
    /// # }
    /// ```
    Warning,
    ...
    /// logwise_runtime::declare_logging_domain!();
    /// # fn main() {
    /// logwise_runtime::error_sync!("Failed to connect: {reason}", reason="timeout");
    /// # }
    /// ```
    Error,
    ...
    /// logwise_runtime::declare_logging_domain!();
    /// # fn main() {
    /// logwise_runtime::mandatory_sync!("Debug: value is {val}", val=42);
    /// # }
    /// ```
    Mandatory,
    ...
    /// logwise_runtime::profile_sync!("Operation took {ms} ms", ms=elapsed_ms);
    /// # }
    /// ```
    Profile,
}
