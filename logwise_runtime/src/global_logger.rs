...
//!
//! ```
//! use logwise_runtime::global_logger::global_loggers;
//!
...
//! # fn main() {
//! use logwise_runtime::global_logger::add_global_logger;
//! use logwise_runtime::InMemoryLogger;
//! use std::sync::Arc;
//!
...
//! logwise_runtime::info_sync!("This goes to multiple loggers");
//! # }
//! ```
//!
...
//! logwise_runtime::declare_logging_domain!();
//! # fn main() {
//! use logwise_runtime::global_logger::set_global_loggers;
//! use logwise_runtime::InMemoryLogger;
//! use std::sync::Arc;
//!
...
//! logwise_runtime::warn_sync!("Only captured in memory");
//! # }
//! ```
//!
...
use logwise_runtime::spinlock::Spinlock;
...
///
/// ```
/// use logwise_runtime::global_logger::{add_global_logger, global_loggers};
/// use logwise_runtime::InMemoryLogger;
/// use std::sync::Arc;
///
...
/// logwise_runtime::info_sync!("This appears in all loggers");
/// # }
/// ```
...
/// logwise_runtime::info_sync!("Only in memory");
/// # }
/// ```
///
...
/// let logger1 = Arc::new(InMemoryLogger::new());
/// let logger2 = Arc::new(InMemoryLogger::new());
/// let loggers: Vec<Arc<dyn logwise_runtime::Logger>> = vec![
///     logger1.clone() as Arc<dyn logwise_runtime::Logger>,
///     logger2.clone() as Arc<dyn logwise_runtime::Logger>,
/// ];
/// set_global_loggers(loggers);
///
/// logwise_runtime::warn_sync!("This goes to both loggers");
/// # }
/// ```
///
