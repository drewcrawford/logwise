...
/// use logwise_runtime::global_logger::{add_global_logger, set_global_loggers};
/// use std::sync::Arc;
///
...
/// logwise_runtime::info_sync!("Test message {value}", value=42);
///
/// // Retrieve the logs
...
///     logwise_runtime::warn_sync!("Something suspicious happened");
///     logwise_runtime::error_sync!("An error occurred: {code}", code=404);
/// }
///
/// # fn test_logging() {
...
///
/// // Run test code
/// logwise_runtime::info_sync!("Test-specific log message");
///
/// // Verify logs
...
impl InMemoryLogger {
    ...
    /// set_global_loggers(vec![logger.clone()]);
    ///
    /// logwise_runtime::info_sync!("First message");
    /// logwise_runtime::warn_sync!("Second message");
    ///
    /// let logs = logger.drain_logs();
    ...
    /// set_global_loggers(vec![logger.clone()]);
    ///
    /// logwise_runtime::error_sync!("Critical error occurred!");
    ///
