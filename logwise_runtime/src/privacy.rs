...
//! logwise_runtime::info_sync!("Processing request {id}", id=request_id);
//!
//! // Use wrappers for explicit control
//! logwise_runtime::info_sync!("User {user} logged in",
//!                     user=logwise_runtime::privacy::LogIt(user_id));
//! # }
//! ```
...
/// logwise_runtime::info_sync!("Processing payment with {card}",
///                     card=LogIt(card));
/// # }
/// ```
///
...
/// logwise_runtime::info_sync!("User data: {data}",
...
/// logwise_runtime::declare_logging_domain!();
/// # fn main() {
/// use logwise_runtime::privacy::IPromiseItsNotPrivate;
///
...
/// logwise_runtime::info_sync!("Event {event} on {server}",
...
/// logwise_runtime::warn_sync!("Product {id} is out of stock",
...
/// logwise_runtime::declare_logging_domain!();
/// # fn main() {
/// use logwise_runtime::privacy::{IPromiseItsNotPrivate, LogIt};
///
/// let public_error_code = "ERR_404";  // Safe to log
/// let user_email = "user@example.com"; // Private data
///
/// // Correct usage:
/// logwise_runtime::error_sync!("Error {code} for user {user}",
