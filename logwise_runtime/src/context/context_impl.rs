...
/// let root = Context::new_task(None, "root_operation".to_string(), logwise_runtime::Level::Info, true);
...
impl Context {
    ...
    /// use logwise_runtime::context::Context;
    ///
    /// let ctx = Context::new_task(None, "my_task".to_string(), logwise_runtime::Level::Info, true);
    ...
    ///
    /// // Create a root task
    /// let root = Context::new_task(None, "main_process".to_string(), logwise_runtime::Level::Info, true);
    ///
    /// // Create a child task
    /// let child = Context::new_task(
    ///     Some(root.clone()),
    ...
    /// logwise_runtime::info_sync!("Starting new session");
    /// # }
    /// ```
    #[inline]
    ...
    /// use logwise_runtime::context::Context;
    ///
    /// let task_ctx = Context::new_task(None, "operation".to_string(), logwise_runtime::Level::Info, true);
    ...
    ///     logwise_runtime::trace_sync!("Detailed debug information");
    /// }
    /// # }
    /// ```
    #[inline]
    ...
    /// logwise_runtime::trace_sync!("This will be logged");
    ///
    ...
    pub fn begin_trace() {
        ...
        logwise_runtime::trace_sync!("Begin trace");
    }
    ...
    /// use logwise_runtime::context::Context;
    ///
    /// let new_ctx = Context::new_task(None, "new_task".to_string(), logwise_runtime::Level::Info, true);
    /// new_ctx.set_current();
    ///
    /// // All logs now use the new context
    /// logwise_runtime::info_sync!("Using new context");
    /// # }
    /// ```
    ...
    /// use logwise_runtime::context::Context;
    ///
    /// let root = Context::new_task(None, "root".to_string(), logwise_runtime::Level::Info, true);
