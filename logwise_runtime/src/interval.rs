...
/// let interval = logwise_runtime::perfwarn_begin!("network_request");
/// perform_expensive_operation();
...
/// # fn main() {
/// # fn perform_expensive_operation() {}
/// let mut interval = logwise_runtime::perfwarn_begin!("partial_operation");
/// perform_expensive_operation();
...
/// let _interval = logwise_runtime::perfwarn_begin_if!(Duration::from_millis(100), "database_query");
