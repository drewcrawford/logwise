...
//! procedural macros in `logwise_runtime_proc`. These functions handle the creation
...
///
/// ```rust
/// # use logwise_runtime::hidden::{debuginternal_pre, debuginternal_sync_post};
...
/// # use logwise_runtime::hidden::debuginternal_sync_post;
...
/// ```rust
/// # use logwise_runtime::{LogRecord, Level};
/// # use logwise_runtime::hidden::debuginternal_async_post;
/// # async fn example() {
/// let record = LogRecord::new(Level::DebugInternal);
/// // ... add message content ...
...
///
/// ```rust
/// # use logwise_runtime::hidden::{info_sync_pre, info_sync_post};
/// // This is typically called by the macro, not directly
...
/// ```rust
/// # use logwise_runtime::{LogRecord, Level};
/// # use logwise_runtime::hidden::info_sync_post;
...
/// ```rust
/// # use logwise_runtime::{LogRecord, Level};
/// # use logwise_runtime::hidden::info_async_post;
/// # async fn example() {
/// let record = LogRecord::new(Level::Info);
/// // ... add message content ...
...
///
/// ```rust
/// # use logwise_runtime::hidden::{warn_sync_pre, warn_sync_post};
/// // This is typically called by the macro, not directly
...
/// ```rust
/// # use logwise_runtime::{LogRecord, Level};
/// # use logwise_runtime::hidden::warn_sync_post;
...
///
/// ```rust
/// # use logwise_runtime::hidden::{trace_sync_pre, trace_sync_post};
/// // This is typically called by the macro, not directly
...
/// ```rust
/// # use logwise_runtime::{LogRecord, Level};
/// # use logwise_runtime::hidden::trace_sync_post;
...
/// ```rust
/// # use logwise_runtime::{LogRecord, Level};
/// # use logwise_runtime::hidden::trace_async_post;
/// # async fn example() {
/// let record = LogRecord::new(Level::Trace);
/// // ... add message content ...
...
///
/// ```rust
/// # use logwise_runtime::hidden::{error_sync_pre, error_sync_post};
/// // This is typically called by the macro, not directly
...
/// ```rust
/// # use logwise_runtime::{LogRecord, Level};
/// # use logwise_runtime::hidden::error_sync_post;
...
/// ```rust
/// # use logwise_runtime::{LogRecord, Level};
/// # use logwise_runtime::hidden::error_async_post;
/// # async fn example() {
/// let record = LogRecord::new(Level::Error);
/// // ... add message content ...
...
///
/// ```rust
/// # use logwise_runtime::hidden::{perfwarn_begin_pre, perfwarn_begin_post};
/// // This is typically called by the macro, not directly
...
/// ```rust
/// # use logwise_runtime::{LogRecord, Level};
/// # use logwise_runtime::hidden::perfwarn_begin_post;
...
mod tests {
    ...
    use logwise_runtime_proc::{debuginternal_sync, info_sync, warn_sync};
    ...
    fn test_log_custom() {
        ...
        struct S(i32);
        let s = S(23);
        debuginternal_sync!("{s}!", s = logwise_runtime::privacy::LogIt(&s));
    }
    ...
    fn test_log_info_async() {
        ...
        let _ = async {
            logwise_runtime::info_async!("test_log_info_async");
        };
    ...
    fn test_trace() {
        ...
        logwise_runtime::trace_sync!("test_trace");
    }
    ...
    fn test_mandatory_sync() {
        ...
        logwise_runtime::mandatory_sync!("mandatory debug value={val}", val = 42);
    }
    ...
    fn test_profile_sync() {
        ...
        logwise_runtime::profile_sync!("profile timing={ms}ms", ms = 100);
    }
    ...
    fn test_profile_begin() {
        ...
        let interval = logwise_runtime::profile_begin!("test_operation {param}", param = "foo");
        // Simulate some work
        let _ = (0..100).sum::<i32>();
        drop(interval);
    }
    ...
    fn test_profile_begin_nested() {
        ...
        let outer = logwise_runtime::profile_begin!("outer_operation");
        {
            let inner = logwise_runtime::profile_begin!("inner_operation");
            let _ = (0..50).sum::<i32>();
            drop(inner);
        }
        drop(outer);
